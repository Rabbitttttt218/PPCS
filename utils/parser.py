...
def get_args():
    ...
    # some args
    # 在 utils/parser.py 的 get_args() 函数中添加：
    parser.add_argument('--analyze', action='store_true', default=False, help='analyze model performance (FLOPs, params, throughput)')
    parser.add_argument('--analyze_batch_size', type=int, default=1, help='batch size for analysis (default: 1)')
